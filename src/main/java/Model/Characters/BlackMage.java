...
public class BlackMage extends Hero{
    ...
    public BlackMage(String name, int experience, int level, int currentHealth, int currentDefence, String weapon, int wbuff, String armour, int aBuff, String helm, int hBuff) {
